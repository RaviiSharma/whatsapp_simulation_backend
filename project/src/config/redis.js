...
//       // Check eviction policy (Windows Redis doesn't allow CONFIG SET)
//       try {
//         const policy = await client.configGet("maxmemory-policy");
//         if (policy && policy["maxmemory-policy"] !== "noeviction") {
//           console.warn(
//             "⚠️ Redis eviction policy is:",
//             policy["maxmemory-policy"],
//           );
//           console.warn(
//             "⚠️ For production, set 'maxmemory-policy noeviction' in redis.conf",
//           );
//           console.warn("⚠️ See fix-redis-config.md for instructions");
//         }
//       } catch (err) {
//         // Ignore - some Redis versions don't support CONFIG GET
//       }
//     });
